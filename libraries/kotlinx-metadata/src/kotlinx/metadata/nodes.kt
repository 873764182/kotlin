...
/**
 * Represents a classifier of a Kotlin type.
 */
 ...
 *
 * @param variance the variance of the type projection, or `null` if this is a star projection
 * @param type the projected type, or `null` if this is a star projection
 */
 ...
 *
 * @param type upper bound of the flexible type
 ...
 * may change in a subsequent release.
 *
 * @param value the constant value. May be `true`, `false` or `null`
 */
